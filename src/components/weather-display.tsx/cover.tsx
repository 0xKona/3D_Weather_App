...
export default function CoverImage({ data }: Props) {
  ...
  return (
      <div className="card bg-base-50 image-full w-full aspect-[16/5] ">
          ...
          <div className="card shadow-xl mb-4 flex-shrink-0">
        <div className="card-body p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm opacity-70">Feels like {current.feelslike_c}°C</div>
            </div>
